...
const [resolvedTasks, setResolvedTasks] = useState([])
  ...
  return (
    <>
     ...
     <div className='flex bg-black text-white justify-around mt-5 pb-15'>
      <div className='mt-10 ml-10'><p className='text-xl font-bold mb-5'>CS Ticket System</p>
     ...
     <div className='bg-black items-center text-white flex justify-center'>2025 CS-Ticket System. All Rights reserved.</div>
  <ToastContainer />
    </>
  )
}
